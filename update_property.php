   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="box">
            ...
            <input type="text" name="address" required maxlength="100" placeholder="Enter Property Address" class="input" value="<?= $fetch_property['address']; ?>">
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <input type="number" name="carpet" required min="1" max="9999999999" maxlength="10" placeholder="How Many SqFts?" class="input" value="<?= $fetch_property['carpet']; ?>">
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <input type="number" name="room_floor" required min="0" max="99" maxlength="2" placeholder="Property Floor Space" class="input" value="<?= $fetch_property['room_floor']; ?>">
         </div>
         <div class="box">
            <p>Loan <span>*</span></p>
      ...
      <div class="checkbox">
         ...
         <div class="box">
            ...
            <p><input type="checkbox" name="shopping_mall" value="yes" <?php if($fetch_property['shopping_mall'] == 'yes'){echo 'checked'; } ?> />Shopping Mall (~wihin 50 m)</p>
            <p><input type="checkbox" name="hospital" value="yes" <?php if($fetch_property['hospital'] == 'yes'){echo 'checked'; } ?> />Hospital (~wihin 30 m)</p>
            <p><input type="checkbox" name="school" value="yes" <?php if($fetch_property['school'] == 'yes'){echo 'checked'; } ?> />School (~wihin 90 m)</p>
            <p><input type="checkbox" name="market_area" value="yes" <?php if($fetch_property['market_area'] == 'yes'){echo 'checked'; } ?> />Market Area (~wihin 100 m)</p>
         </div>
      </div>
      <div class="box">
