   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="box">
            ...
            <input type="number" name="room_floor" required min="0" max="99" maxlength="2" placeholder="Property Floor Space" class="input">
         </div>
         <div class="box">
            <p>Loan <span>*</span></p>
      ...
      <div class="checkbox">
         ...
         <div class="box">
            ...
            <p><input type="checkbox" name="shopping_mall" value="yes" />Shopping Mall (~within 50 m)</p>
            <p><input type="checkbox" name="hospital" value="yes" />Hospital (~within 30 m)</p>
            <p><input type="checkbox" name="school" value="yes" />School (~within 90 m)</p>
            <p><input type="checkbox" name="market_area" value="yes" />Market Area (~within 100 m)</p>
         </div>
      </div>
      <div class="box">
